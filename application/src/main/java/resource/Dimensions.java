...
public class Dimensions {
    ...
    public static final Dimension LARGE_GAP = new Dimension(20, 20);
    ...
    public static final Dimension ENTITY_COMPONENT_SIZE = new Dimension(WINDOW_WIDTH / 2, COMPONENT_HEIGHT);
    ...
    public static final Dimension CREATE_TRANSACTION_WINDOW_COMPONENT_SMALLER_SIZE =
            new Dimension(CREATE_TRANSACTION_WINDOW_COMPONENT_SIZE.width,
                    CREATE_TRANSACTION_WINDOW_COMPONENT_SIZE.height / 2);
}
